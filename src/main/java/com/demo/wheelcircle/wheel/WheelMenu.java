package com.demo.wheelcircle.wheel;
...
public class WheelMenu {
    ...
    private static String TAG = WheelMenu.class.getSimpleName();
    ...
    private double top; // the current top of the wheel
    ...
    private double divcount; // variable that counts the no of divisons in the
    // wheel
    private double divangle; // variable that holds the angle of each division
    public double selected; // the currently selected option by the user
    ...
    private WheelSelectionListener mCallback;

    /**
     *
     * Context, no_of_divisions_in_the_menu,
    ...
    public WheelMenu(Context context_par, int divcount_par, int drawable_id,
        ...
        context = context_par;
        this.mCallback = (WheelSelectionListener) context;
        ...
        public boolean onTouch(View v, MotionEvent event) {
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    mCallback.onWheelSelectedListener((int) selected);
                    break;
            }
